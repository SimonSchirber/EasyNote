    ...
    constructor(root, {onNoteSelect, onNoteAdd, onNoteEdit, onNoteDelete} = {}) {
        ...
        this.root.innerHTML = `
            ...
            <div class="notes__preview">
                <div class = "notes_bar">
                    <button name="submit" class="save_btn" type="submit" value="Save" onclick="myFunction()">Save</button>
                    <button name="submit" class="delete_btn" type="submit" value="Delete" onclick="myFunction2()">Delete</button>
                </div>
